...
- **WHEN** a user opens the control console in either the unconfigured or configured state
- **THEN** the frontend MUST render the corresponding content-panel composition, action hierarchy, and visual density from the approved reference for that state
